...
import { Download, Upload, RefreshCw, CheckCircle, AlertTriangle, Database, Shield, Info } from 'lucide-react';
import { useSupabase } from '../hooks/useSupabase';
import { getCurrentUser } from '../lib/deviceAuth';

const DataBackupRecovery: React.FC = () => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6">
      <div className="flex items-center space-x-3 mb-6">
        ...
        <h2 className="text-xl font-jp-bold text-gray-900">データのバックアップと復元</h2>
      </div>
